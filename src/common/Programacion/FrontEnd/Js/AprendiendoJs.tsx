        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                <FaCode className="text-2xl text-yellow-400" />
                <h2 className="text-2xl font-semibold text-white">{ejemplosJSIntermedio[ejemploActual].titulo}</h2>
              </div>
              <p className="text-gray-300 mb-4">{ejemplosJSIntermedio[ejemploActual].descripcion}</p>
              <pre className="bg-gray-900/80 p-6 rounded-lg overflow-x-auto text-sm text-white font-mono border border-yellow-500/20">
                {ejemplosJSIntermedio[ejemploActual].codigo}
              </pre>
            </motion.div>
            ...
            >
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-yellow-500/30">
                ...
                <pre className="bg-gray-900/80 p-6 rounded-lg overflow-x-auto text-sm text-green-400 font-mono border border-yellow-500/20">
                  {ejemplosJSIntermedio[ejemploActual].resultado}
                </pre>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-yellow-500/30">
                <h3 className="text-xl font-semibold text-white mb-4">Explicación</h3>
                <p className="text-gray-300 whitespace-pre-line">
                  {ejemplosJSIntermedio[ejemploActual].explicacion}
                </p>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => setEjemploActual((prev) => Math.min(ejemplosJSIntermedio.length - 1, prev + 1))}
              disabled={ejemploActual === ejemplosJSIntermedio.length - 1}
              className={`flex items-center space-x-2 px-6 py-3 rounded-xl backdrop-blur-sm transition-all
                ${ejemploActual === ejemplosJSIntermedio.length - 1
                  ? 'bg-gray-800/30 text-gray-500 cursor-not-allowed border border-gray-700/30'
                  : 'bg-yellow-600/50 text-white border border-yellow-500/50 hover:bg-yellow-500/60'}
              `}
            >
      ...
      <div className="relative min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 p-8 overflow-hidden">
        ...
        >
          ...
          >
            <div className="flex items-center justify-center space-x-4 mb-4">
              <FaJs className="text-6xl text-yellow-400" />
              <h1 className="text-5xl font-bold text-white">Aprendiendo JavaScript Avanzado</h1>
            </div>
            <p className="text-gray-300 text-xl">Fundamentos de programación Avanzado con JavaScript</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                <FaCode className="text-2xl text-yellow-400" />
                <h2 className="text-2xl font-semibold text-white">{ejemplosAvanzados[ejemploActual].titulo}</h2>
              </div>
              <p className="text-gray-300 mb-4">{ejemplosAvanzados[ejemploActual].descripcion}</p>
              <pre className="bg-gray-900/80 p-6 rounded-lg overflow-x-auto text-sm text-white font-mono border border-yellow-500/20">
                {ejemplosAvanzados[ejemploActual].codigo}
              </pre>
            </motion.div>
            ...
            >
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-yellow-500/30">
                ...
                <pre className="bg-gray-900/80 p-6 rounded-lg overflow-x-auto text-sm text-green-400 font-mono border border-yellow-500/20">
                  {ejemplosAvanzados[ejemploActual].resultado}
                </pre>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-yellow-500/30">
                <h3 className="text-xl font-semibold text-white mb-4">Explicación</h3>
                <p className="text-gray-300 whitespace-pre-line">
                  {ejemplosAvanzados[ejemploActual].explicacion}
                </p>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => setEjemploActual((prev) => Math.min(ejemplosAvanzados.length - 1, prev + 1))}
              disabled={ejemploActual === ejemplosAvanzados.length - 1}
              className={`flex items-center space-x-2 px-6 py-3 rounded-xl backdrop-blur-sm transition-all
                ${ejemploActual === ejemplosAvanzados.length - 1
                  ? 'bg-gray-800/30 text-gray-500 cursor-not-allowed border border-gray-700/30'
                  : 'bg-yellow-600/50 text-white border border-yellow-500/50 hover:bg-yellow-500/60'}
              `}
            >
